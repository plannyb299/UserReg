...
import com.example.userregistration.model.PasswordModel;
...
public class RegistrationController {
    ...
    public RegistrationController(EmailSender emailSender, UserService userService, ApplicationEventPublisher publisher) {
    ...
    private String passwordResetTokenMail(AppUser user, String applicationUrl, String token) {
        ...
        emailSender.send(
                user.getEmail(),
                emailSender.buildEmail(user.getFirstName(), url));
    ...
    private void resendVerificationTokenMail(AppUser user, String applicationUrl, VerificationToken verificationToken) {
        String url =
                applicationUrl
